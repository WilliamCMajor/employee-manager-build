...
`;function Oe(r){return document.createRange().createContextualFragment(r).firstElementChild}var T=Oe;var xe=function(){return T(G)},Z=xe;function K(r,n,s){return s={path:n,exports:{},require:function(o,c){return Ie(o,c??s.path)}},r(s,s.exports),s.exports}function Ie(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var P={};function Y(r,n){for(var s=0,o=r.length-1;o>=0;o--){var c=r[o];c==="."?r.splice(o,1):c===".."?(r.splice(o,1),s++):s&&(r.splice(o,1),s--)}if(n)for(;s--;s)r.unshift("..");return r}var Me=/^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/,q=function(r){return Me.exec(r).slice(1)};function M(){for(var r="",n=!1,s=arguments.length-1;s>=-1&&!n;s--){var o=s>=0?arguments[s]:"/";if(typeof o!="string")throw new TypeError("Arguments to path.resolve must be strings");if(!o)continue;r=o+"/"+r,n=o.charAt(0)==="/"}return r=Y(k(r.split("/"),function(c){return!!c}),!n).join("/"),(n?"/":"")+r||"."}function B(r){var n=N(r),s=Re(r,-1)==="/";return r=Y(k(r.split("/"),function(o){return!!o}),!n).join("/"),!r&&!n&&(r="."),r&&s&&(r+="/"),(n?"/":"")+r}function N(r){return r.charAt(0)==="/"}function ee(){var r=Array.prototype.slice.call(arguments,0);return B(k(r,function(n,s){if(typeof n!="string")throw new TypeError("Arguments to path.join must be strings");return n}).join("/"))}function te(r,n){r=M(r).substr(1),n=M(n).substr(1);function s(g){for(var _=0;_<g.length&&g[_]==="";_++);for(var w=g.length-1;w>=0&&g[w]==="";w--);return _>w?[]:g.slice(_,w-_+1)}for(var o=s(r.split("/")),c=s(n.split("/")),h=Math.min(o.length,c.length),m=h,u=0;u<h;u++)if(o[u]!==c[u]){m=u;break}for(var p=[],u=m;u<o.length;u++)p.push("..");return p=p.concat(c.slice(m)),p.join("/")}var ne="/",re=":";function ae(r){var n=q(r),s=n[0],o=n[1];return!s&&!o?".":(o&&(o=o.substr(0,o.length-1)),s+o)}function ie(r,n){var s=q(r)[2];return n&&s.substr(-1*n.length)===n&&(s=s.substr(0,s.length-n.length)),s}function se(r){return q(r)[3]}var Pe={extname:se,basename:ie,dirname:ae,sep:ne,delimiter:re,relative:te,join:ee,isAbsolute:N,normalize:B,resolve:M};function k(r,n){if(r.filter)return r.filter(n);for(var s=[],o=0;o<r.length;o++)n(r[o],o,r)&&s.push(r[o]);return s}var Re="ab".substr(-1)==="b"?function(r,n,s){return r.substr(n,s)}:function(r,n,s){return n<0&&(n=r.length+n),r.substr(n,s)},qe=Object.freeze({__proto__:null,resolve:M,normalize:B,isAbsolute:N,join:ee,relative:te,sep:ne,delimiter:re,dirname:ae,basename:ie,extname:se,default:Pe}),E=K(function(r,n){var s=/[|\\{}()[\]^$+*?.]/g;n.escapeRegExpChars=function(u){return u?String(u).replace(s,"\\$&"):""};var o={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&#34;","'":"&#39;"},c=/[&<>'"]/g;function h(u){return o[u]||u}var m=`var _ENCODE_HTML_RULES = {
      "&": "&amp;"
    , "<": "&lt;"
    , ">": "&gt;"
    , '"': "&#34;"
...
`+m},n.shallowCopy=function(u,p){p=p||{};for(var g in p)u[g]=p[g];return u},n.shallowCopyFromList=function(u,p,g){for(var _=0;_<g.length;_++){var w=g[_];typeof p[w]!="undefined"&&(u[w]=p[w])}return u},n.cache={_data:{},set:function(u,p){this._data[u]=p},get:function(u){return this._data[u]},remove:function(u){delete this._data[u]},reset:function(){this._data={}}},n.hyphenToCamel=function(u){return u.replace(/-[a-z]/g,function(p){return p[1].toUpperCase()})}}),ke=[["ejs@3.1.6","C:\\Users\\William.SQ\\Documents\\DMIT2008 Front-end\\employee-manager-lecture\\day10\\employee-manager"]],Ne="ejs@3.1.6",Be="ejs@3.1.6",He=!1,We="sha512-9lt9Zse4hPucPkoP7FHDF0LQAlGyF9JVpnClFLFH3aSSbxmyoqINRpp/9wePWJTUl4KOQwRL72Iw3InHPDkoGw==",Ue="/ejs",$e={},Je={type:"version",registry:!0,raw:"ejs@3.1.6",name:"ejs",escapedName:"ejs",rawSpec:"3.1.6",saveSpec:null,fetchSpec:"3.1.6"},Ve=["/"],ze="https://registry.npmjs.org/ejs/-/ejs-3.1.6.tgz",Xe="3.1.6",Ge="C:\\Users\\William.SQ\\Documents\\DMIT2008 Front-end\\employee-manager-lecture\\day10\\employee-manager",Qe={name:"Matthew Eernisse",email:"mde@fleegix.org",url:"http://fleegix.org"},Ze={ejs:"bin/cli.js"},Ke={url:"https://github.com/mde/ejs/issues"},Ye={jake:"^10.6.1"},et="Embedded JavaScript templates",tt={browserify:"^16.5.1",eslint:"^6.8.0","git-directory-deploy":"^1.5.1",jsdoc:"^3.6.4","lru-cache":"^4.0.1",mocha:"^7.1.1","uglify-js":"^3.3.16"},nt={node:">=0.10.0"},rt="https://github.com/mde/ejs",at="ejs.min.js",it=["template","engine","ejs"],st="Apache-2.0",ot="./lib/ejs.js",lt="ejs",ct={type:"git",url:"git://github.com/mde/ejs.git"},ut={test:"mocha"},mt="ejs.min.js",dt="3.1.6",pt={_args:ke,_from:Ne,_id:Be,_inBundle:He,_integrity:We,_location:Ue,_phantomChildren:$e,_requested:Je,_requiredBy:Ve,_resolved:ze,_spec:Xe,_where:Ge,author:Qe,bin:Ze,bugs:Ke,dependencies:Ye,description:et,devDependencies:tt,engines:nt,homepage:rt,jsdelivr:at,keywords:it,license:st,main:ot,name:lt,repository:ct,scripts:ut,unpkg:mt,version:dt},ft=K(function(r,n){var s=qe,o=!1,c=pt.version,h="<",m=">",u="%",p="locals",g="ejs",_="(<%%|%%>|<%=|<%-|<%_|<%#|<%|%>|-%>|_%>)",w=["delimiter","scope","context","debug","compileDebug","client","_with","rmWhitespace","strict","filename","async"],ye=w.concat("cache"),W=/^\uFEFF/;n.cache=E.cache,n.fileLoader=P.readFileSync,n.localsName=p,n.promiseImpl=new Function("return this;")().Promise,n.resolveInclude=function(t,a,e){var i=s.dirname,l=s.extname,d=s.resolve,v=d(e?a:i(a),t),j=l(t);return j||(v+=".ejs"),v};function U(t,a){var e;if(a.some(function(i){return e=n.resolveInclude(t,i,!0),P.existsSync(e)}))return e}function Ee(t,a){var e,i,l=a.views,d=/^[A-Za-z]+:\\|^\//.exec(t);if(d&&d.length)t=t.replace(/^\/*/,""),Array.isArray(a.root)?e=U(t,a.root):e=n.resolveInclude(t,a.root||"/",!0);else if(a.filename&&(i=n.resolveInclude(t,a.filename),P.existsSync(i)&&(e=i)),!e&&Array.isArray(l)&&(e=U(t,l)),!e&&typeof a.includer!="function")throw new Error('Could not find the include file "'+a.escapeFunction(t)+'"');return e}function F(t,a){var e,i=t.filename,l=arguments.length>1;if(t.cache){if(!i)throw new Error("cache option requires a filename");if(e=n.cache.get(i),e)return e;l||(a=$(i).toString().replace(W,""))}else if(!l){if(!i)throw new Error("Internal EJS error: no file name or template provided");a=$(i).toString().replace(W,"")}return e=n.compile(a,t),t.cache&&n.cache.set(i,e),e}function _e(t,a,e){var i;if(e){try{i=F(t)(a)}catch(l){return e(l)}e(null,i)}else{if(typeof n.promiseImpl=="function")return new n.promiseImpl(function(l,d){try{i=F(t)(a),l(i)}catch(v){d(v)}});throw new Error("Please provide a callback function")}}function $(t){return n.fileLoader(t)}function we(t,a){var e=E.shallowCopy({},a);if(e.filename=Ee(t,e),typeof a.includer=="function"){var i=a.includer(t,e.filename);if(i&&(i.filename&&(e.filename=i.filename),i.template))return F(e,i.template)}return F(e)}function J(t,a,e,i,l){var d=a.split(`
...
`)}},n.escapeXML=E.escapeXML,n.__express=n.renderFile,n.VERSION=c,n.name=g,typeof window!="undefined"&&(window.ejs=n)}),oe=ft;function ht(r,n){return oe.render(r,{data:n})}var A=ht;var vt=D.getInstance(),le=new CustomEvent("sideBarSelect",{bubbles:!0,detail:{name:null}}),yt=function(r){let n=A(Q,r),s=T(n);return s.addEventListener("click",gt),s},gt=r=>{le.detail.name=r.currentTarget.dataset.name,vt.handle.dispatchEvent(le)},ce=yt;var Et=document.querySelector("#sidebar"),_t=function(){return{init:function(n){let s=Z();n.forEach(o=>{let c=ce(o);s.append(c)}),Et.append(s)}}},ue=_t;var wt=`
